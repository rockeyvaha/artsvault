...
class AdminPurchaseHistoryPage extends StatefulWidget {
  const  AdminPurchaseHistoryPage({super.key});

  @override
  _AdminPurchaseHistoryPageState createState() => _AdminPurchaseHistoryPageState();
}

class _AdminPurchaseHistoryPageState extends State< AdminPurchaseHistoryPage> {
