...
class Kebarung extends StatelessWidget {
  const Kebarung({super.key});
...
class KebarungPage extends StatefulWidget {
  const KebarungPage({super.key});

  @override
  _KebarungPageState createState() => _KebarungPageState();
}

class _KebarungPageState extends State<KebarungPage> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Center(
              child: Text(
                'This is a combination of the traditional kebaya and baju kurung. It became popular in the 1920s and is known for its long, elegant cut that combines the tight-fitting kebaya with the loose, modest baju kurung.',
                style: TextStyle(
                  fontSize: 16,
                  color: Colors.grey,
                ),
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Image.asset(
                'assets/melayu.jpg', // Replace with actual image
                height: 50,
              ),
