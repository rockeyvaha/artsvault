...
class IbanPerempuan extends StatelessWidget {
  const IbanPerempuan({super.key});

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(
      debugShowCheckedModeBanner: false,
      home: IbanPerempuanPage(),
    );
  }
}

class IbanPerempuanPage extends StatefulWidget {
  const IbanPerempuanPage({super.key});

  @override
  _IbanPerempuanPageState createState() => _IbanPerempuanPageState();
}

class _IbanPerempuanPageState extends State<IbanPerempuanPage> {
            ...
            Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                  builder: (context) => const ClothesPage(
                      searchQuery: '')), // Pass required searchQuery
            );
          },
        ),
        actions: [
          Stack(
            children: [
              IconButton(
                ...
                onPressed: () {
                  // Navigate to CartPage when the cart icon is pressed
                  Navigator.push(
                    context,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Image.asset(
                'assets/iban.jpg', // Replace with the actual Iban costume image
                height: 200,
              ),
            ),
            ...
            const Center(
              child: Text(
                'This traditional attire for Iban women includes a kain kebat (woven skirt), selampai (sash), and various silver accessories. It is believed to have originated from the legendary figure Kumang, who was known for her beauty and skill in weaving.',
                style: TextStyle(
                  fontSize: 16,
                  color: Colors.grey,
                ),
