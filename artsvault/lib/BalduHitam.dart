...
class Balduhitam extends StatelessWidget {
  const Balduhitam({super.key});
...
class BalduhitamPage extends StatefulWidget {
  const BalduhitamPage({super.key});

  @override
  _BalduhitamPageState createState() => _BalduhitamPageState();
}

class _BalduhitamPageState extends State<BalduhitamPage> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Image.asset(
                'assets/melanau2.jpg', // Replace with the actual Iban costume image
                height: 200,
              ),
            ),
            ...
            const Center(
              child: Text(
                'This black velvet dress is worn by Melanau women and signifies elegance and cultural pride. Typically accessorized with a large belt and traditional jewelry.',
                style: TextStyle(
                  fontSize: 16,
                  color: Colors.grey,
                ),
            ...
            const Text(
              'Rented clothing must be returned within [3-5 days] in the same condition as received—clean, undamaged, and without alterations.',
              style: TextStyle(fontSize: 14),
            ),
            const Spacer(),
            SizedBox(
...
class _AddToCartPopupState extends State<AddToCartPopup> {
  ...
  void _saveToCart() async {
    final cartData = {
      'name': 'Baju Baldu Hitam Melanau', // Name of the costume
      'size': selectedSize, // Selected size
      'quantity': quantity, // Quantity
      'price': (quantity * pricePerItem).toStringAsFixed(2), // Total price
      'imageUrl': 'assets/melanau2.jpg', // Path to the image
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Image.asset(
                'assets/melanau2.jpg', // Replace with the actual image
                height: 50,
              ),
