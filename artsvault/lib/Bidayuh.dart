...
class Bidayuh extends StatelessWidget {
  const Bidayuh({super.key});
...
class BidayuhPage extends StatefulWidget {
  const BidayuhPage({super.key});

  @override
  _BidayuhPageState createState() => _BidayuhPageState();
}

class _BidayuhPageState extends State<BidayuhPage> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Image.asset(
                'assets/bidayuh.jpg', // Replace with the actual Bidayuh costume image
                height: 200,
              ),
            ),
